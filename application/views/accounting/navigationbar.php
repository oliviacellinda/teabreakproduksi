            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li id="dashboardsuperadmin">
                        <a href="<?=base_url('dashboardaccounting');?>"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>

                    <h3 class="menu-title">PRODUKSI</h3><!-- /.menu-title -->
                    <li id="bahanbakumasuk">
                        <a href="<?=base_url('notapembelian');?>"> <i class="menu-icon ti-package"></i>Nota dan Laporan Pembelian</a>
                    </li>
                </ul>
            </div>

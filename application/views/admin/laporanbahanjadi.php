                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">List Bahan Jadi</strong>
                            </div>
                            <div class="card-body">
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function($) {
            ...
            tabel = jQuery('#tabelData').dataTable({
                ...
                ajax : {
                    type    : 'POST',
                    url     : '<?=base_url('admin/laporanStokBahanJadi');?>',
                    data    : function(data) {

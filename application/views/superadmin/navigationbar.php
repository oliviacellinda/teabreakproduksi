            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li id="dashboardsuperadmin">
                        <a href="<?=base_url('dashboardsuperadmin');?>"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>

                    <h3 class="menu-title">PRODUKSI</h3><!-- /.menu-title -->
                    <li id="masterbahanbaku">
                        <a href="<?=base_url('masterbahanbaku');?>"> <i class="menu-icon ti-package"></i>Master Data Bahan Baku</a>
                    </li>
                    <li id="masterbahanjadi">
                        <a href="<?=base_url('masterbahanjadi');?>"> <i class="menu-icon fa fa-glass"></i>Master Data Bahan Jadi</a>
                    </li>
                    <li id="masterresep">
                        <a href="<?=base_url('masterresep');?>"> <i class="menu-icon ti-notepad"></i>Master Data Resep</a>
                    </li>
                    <li id="masterdatacabang">
                        <a href="<?=base_url('mastercabang');?>"> <i class="menu-icon fa fa-building"></i>Master Data Cabang</a>
                    </li>
                    <li id="masterdatasupplier">
                        <a href="<?=base_url('mastersupplier');?>"> <i class="menu-icon fa fa-cubes"></i>Master Data Supplier</a>
                    </li>
                </ul>
            </div>
